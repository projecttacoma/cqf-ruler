...
public class ActivityDefinitionProvider extends ActivityDefinitionResourceProvider
{
    private JpaDataProvider provider;
    private CqlExecutionProvider executionProvider;

    public ActivityDefinitionProvider(JpaDataProvider provider)
    {
            ...
            throws FHIRException
    {
        ...
        if (activityDefinition.hasProduct()) {
            ...
            throw new FHIRException("Missing required product property");
        }
